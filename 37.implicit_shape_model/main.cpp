...
main (int argc, char** argv)
{
  ...
  unsigned int number_of_training_clouds = (argc - 3) / 2;  //代表什么？
  ...
  std::vector<unsigned int> training_classes;   //训练分类？？？
  ...
  pcl::ism::ImplicitShapeModelEstimation<153, pcl::PointXYZ, pcl::Normal> ism;  //ism需要3个参数，
  ...
  model->saveModelToFile (file);    //训练保存
